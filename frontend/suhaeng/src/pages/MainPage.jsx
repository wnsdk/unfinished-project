      ...
      <div className={styles.gradient}>
        <div className={styles.box2}>
          <div className={styles.box2_1}>
            {!isLoading &&
              feeds.map((feed, i) => <Component1 key={i} feed={feed} />)}
          </div>
          ...
          {loginUser.isLogin ? (
            ...
            <div className={styles.loginButton}>로그인하기</div>
          )}
        </div>
        ...
        <div className={styles.box1}>
          ...
          <div>
            혼자 하는 수행이 아닙니다
            <br />
            우리는 모두 <span className={styles.highlight}>연결</span>되어
            있습니다
          </div>
          <div>
          ...
          <div className={styles.box1_3}>
            <div>
              오늘 <span className={styles.cnt}>{cnt}</span> 명의 수행자들이
              함께 하고 있습니다
            </div>
